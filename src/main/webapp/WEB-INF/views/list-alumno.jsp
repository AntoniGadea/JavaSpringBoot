	...
	<div class="container">
		...
		<thead class="thead-light">
			...
			<c:forEach items="${alumnos}" var="alumno">
				...
				<td> <a class="btn btn-success" href="/update-alumno?dni=${alumno.getDni()}"><spring:message code="boton.modificar" /></a> </td>
				<td> <a class="btn btn-danger" href="/del-alumno?dni=${alumno.getDni()}"><spring:message code="boton.borrar" /></a> </td>
				<td> <a class="btn btn-success" href="/list-documentacion?dni=${alumno.getDni()}
